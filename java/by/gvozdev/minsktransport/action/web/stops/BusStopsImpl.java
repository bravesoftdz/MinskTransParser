...
public class BusStopsImpl implements BaseAction {
	...
	public void doHttpReqRes(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		Map<String, Map<String, List<StopsName>>> stops = dao.getBusStops(stop);
		...
		if (stops != null) {
			...
			String answer = noDataReply.noDataReceived("BusStopsImpl", "getBusStops");
			out.print(answer);
			out.close();
		}
