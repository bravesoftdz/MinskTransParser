...
public class TrolleybusStopsImpl implements BaseAction {
	...
	public void doHttpReqRes(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		Map<String, Map<String, List<StopsName>>> stops = dao.getTrolleyBusStops(stop);
		...
		if (stops != null) {
			...
			String answer = noDataReply.noDataReceived("TrolleybusStopsImpl", "getTrolleyBusStops");
			out.print(answer);
			out.close();
		}
