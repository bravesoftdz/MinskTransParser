...
public class TrolleybusScheduleImpl implements BaseAction {
	...
	public void doHttpReqRes(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		Map<String, Map<String, List<Schedule>>> sch = dao.getTrolleyBusSchedule(schedule);
		...
		if (sch != null) {
			...
			String answer = noDataReply.noDataReceived("TrolleybusScheduleImpl", "getTrolleyBusSchedule");
			out.print(answer);
			out.close();
		}
