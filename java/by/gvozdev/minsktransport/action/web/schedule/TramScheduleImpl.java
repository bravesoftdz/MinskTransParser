...
public class TramScheduleImpl implements BaseAction {
	...
	public void doHttpReqRes(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		Map<String, Map<String, List<Schedule>>> sch = dao.getTramSchedule(schedule);
		...
		if (sch != null) {
			...
			String answer = noDataReply.noDataReceived("TramScheduleImpl", "getTramSchedule");
			out.print(answer);
			out.close();
		}
